...
export function IconTrophy({ className }: { className?: string }) {
  return (
    <svg className={className} fill="none" stroke="currentColor" viewBox="0 0 24 24">
      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 3h14v4a4 4 0 01-4 4H9a4 4 0 01-4-4V3zM5 7h14M9 21h6M12 17v4M7 21h10a2 2 0 002-2v-2H5v2a2 2 0 002 2zM7 7V5a2 2 0 012-2h6a2 2 0 012 2v2" />
    </svg>
  );
}
